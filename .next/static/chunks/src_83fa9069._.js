...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$educacion$2f$ui$2f$Icons$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/educacion/ui/Icons.tsx [app-client] (ecmascript)");
(()=>{
    const e = new Error("Cannot find module '@/components/educacion/forms/FormularioEntrevistaInicial'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '@/components/educacion/forms/FormularioInformeInicial'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '@/components/educacion/forms/FormularioEntrevistaSeguimiento'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '@/components/educacion/forms/FormularioInformeSeguimiento'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
...
//# sourceMappingURL=src_83fa9069._.js.map